...
public class GCS {
    ...
    @Localize(locale = "pt_BR", value = "GURPS Ficha de personagem")
    ...
    @Localize(locale = "pt_BR", value = "Biblioteca de vantagens CGS")
    ...
    @Localize(locale = "pt_BR", value = "Biblioteca de equipamentos CGS")
    ...
    @Localize(locale = "pt_BR", value = "Biblioteca de perícias CGS")
    ...
    @Localize(locale = "pt_BR", value = "Biblioteca de magias CGS")
    private static String SPELLS_LIBRARY_DESCRIPTION;
    @Localize("GCS Notes Library")
    @Localize(locale = "pt_BR", value = "Biblioteca de notas CGS")
    ...
    @Localize(locale = "pt_BR", value = "Bibliotecas CGS")
    ...
    @Localize(locale = "pt_BR", value = "Template de personagem CGS")
    ...
    @Localize(locale = "pt_BR", value = "Criar versões em pdf das fichas especificadas na linha de comando")
    private static String PDF_OPTION_DESCRIPTION;
    @Localize("Create text versions of sheets specified on the command line.")
    @Localize(locale = "pt_BR", value = "Criar versões em texto das fichas especificadas na linha de comando")
    ...
    @Localize(locale = "pt_BR", value = "Um template para usar quando criar versões em texto das fichas. Se não especificado, o template usado por padrão será o encontrado na pasta data.")
    ...
    @Localize(locale = "pt_BR", value = "Arquivo")
    ...
    @Localize(locale = "pt_BR",
            value = "Criar versões em PNG das fichas selecionadas na linha de comando")
    ...
    @Localize(locale = "pt_BR",
          value = "Quando gerar PDF ou PNG pela linha de comando, especifique o tamanho do papel para usar ao invés do padrão. Opções válidas são: Carta, A4, ou largura e altura em polegadas e separadas por 'x', como '5x7'")
    ...
    @Localize(locale = "pt_BR",
              value = "Quando gerar PDF ou PNG pela linha de comando, especifique as margens para usar ao invés do padrão. A superior, esquerda, inferior e direita precisam ser especificadas em polegadas e separadas por '':', como '1:1:1:1'.")
    ...
    @Localize(locale = "pt_BR",
              value = "Selecione uma ou mais fichas para processar.")
    ...
    @Localize(locale = "pt_BR", value = "Carregando \"{0}\"...")
    ...
    @Localize(locale = "pt_BR", value = "  Gerando PDF... ")
    private static String CREATING_PDF;
    @Localize("  Creating from text template... ")
    @Localize(locale = "pt_BR", value = "  Criando a partir de um template de texto... ")
    ...
    @Localize(locale = "pt_BR", value = "  Gerando PNG... ")
    ...
    @Localize(locale = "pt_BR", value = "  ** ERRO ENCONTRADO **")
    ...
    @Localize(locale = "pt_BR", value = "    Criado: \"{0}\".")
    ...
    @Localize(locale = "pt_BR", value = "AVISO: Tamanho do papel inválido")
    ...
    @Localize(locale = "pt_BR", value = "AVISO: As margens especificadas são inválidas")
    private static String INVALID_PAPER_MARGINS;
    @Localize("    Used text template file \"{0}\".")
    @Localize(locale = "pt_BR", value = "Arquivo de template usado \"{0}\".")
